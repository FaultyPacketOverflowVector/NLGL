...
public class GTAV : Form
{
	...
	{
		string text = selectedFolderPath + "\\PlayGTAV.exe";
		if (File.Exists(text))
		{
			try
			{
	...
	private void DownloadFiles()
	{
		...
		{
			{ "PlayGTAV.exe", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAV/PlayGTAV.exe" },
			{ "launc.dll", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAV/launc.dll" },
			{ "orig_socialclub.dll", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAV/orig_socialclub.dll" },
			{ "bink2w64.dll", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAV/bink2w64.dll" },
			{ "socialclub.dll", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAV/socialclub.dll" }
		};
		string path = selectedFolderPath + "\\GTAV.exe";
		string path2 = selectedFolderPath + "\\GTA5.exe";
		string path3 = selectedFolderPath + "\\PlayGTAV.exe";
	...
	private void InitializeComponent()
	{
		...
		this.OpenGameLocation.Size = new System.Drawing.Size(123, 39);
		...
		this.OpenGameLocation.Click += new System.EventHandler(OpenGameDir_Click);
		...
		this.labelOptiBoost1.Location = new System.Drawing.Point(196, 66);
		this.labelOptiBoost1.Name = "labelOptiBoost1";
		this.labelOptiBoost1.Size = new System.Drawing.Size(334, 44);
