...
public class GTAIV : Form
{
	...
	{
		string text = selectedFolderPath + "\\PlayGTAIV.exe";
		if (File.Exists(text))
		{
			try
			{
	...
	private void DownloadFiles()
	{
		...
		{
			{ "PlayGTAIV.exe", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAIV/PlayGTAIV.exe" },
			{ "binkw32.dll", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAIV/binkw32.dll" },
			{ "launc.dll", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAIV/launc.dll" },
			{ "orig_socialclub.dll", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAIV/orig_socialclub.dll" },
			{ "socialclub.dll", "https://github.com/onajlikezz/Nightlight-Game-Launcher/raw/main/Modules/GTAIV/socialclub.dll" }
		};
		string path = selectedFolderPath + "\\GTAIV.exe";
		if (File.Exists(path))
		{
	...
	private void InitializeComponent()
	{
		...
		this.labelOptiBoost1.Location = new System.Drawing.Point(191, 66);
		this.labelOptiBoost1.Name = "labelOptiBoost1";
		this.labelOptiBoost1.Size = new System.Drawing.Size(346, 44);
		this.labelOptiBoost1.TabIndex = 6;
		this.labelOptiBoost1.Text = "Grand Theft Auto IV";
		this.OpenGameLocation.Font = new System.Drawing.Font("Trebuchet MS", 8.25f);
		this.OpenGameLocation.Location = new System.Drawing.Point(95, 271);
		this.OpenGameLocation.Name = "OpenGameLocation";
		this.OpenGameLocation.Size = new System.Drawing.Size(119, 39);
